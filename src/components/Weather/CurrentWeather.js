...
const CurrentWeather = () => {
    ...
    // Lon Lat Call for 7 days forecast https://api.openweathermap.org/data/2.5/onecall?lat=51.51&lon=-0.13&units=metric&exclude=current,minutely,hourly&appid=~4{apiKey}
